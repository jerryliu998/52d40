...
class base_Utils {
    ...
    public static function getOrderStatus() {
        return array(
            base_Constant::ORDER_STATUS_INVALID=>"无效",
            base_Constant::ORDER_STATUS_NEW=>"未支付",
            base_Constant::ORDER_STATUS_PAY=>"已支付",
            base_Constant::ORDER_STATUS_OK=>"已完成",
            base_Constant::ORDER_STATUS_CANCEL=>"已取消",
            base_Constant::ORDER_STATUS_REFUND=>"已退款"
        );
    }
